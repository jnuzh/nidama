...
class CVS:
    ...
    def _run(self, argv, cwd=None, require_cvs_root=True, terminalHandler=None,
             ignore_retval=False):
        output = ''
        error = ''
        try:
            ...
            sys.stderr.write("Error running %s." % argv)
            raise
        finally:
    ...
    def status(self, files=[], recursive=None, showTags=0, cwd=None):
        ...
        # we now have a basdir such as /respository/module
