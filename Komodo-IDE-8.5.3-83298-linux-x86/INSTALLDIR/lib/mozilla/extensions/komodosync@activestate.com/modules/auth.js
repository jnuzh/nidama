...
function KomodoSsoAuthenticator(id) {
  this._id = id; // an nsILoginInfo containing the SSO username and session key
}
KomodoSsoAuthenticator.prototype = {
  onRequest: function onRequest(headers) {
    headers['Authorization'] = 'komodo-sso ' + this._id.passwordUTF8;
    return headers;
  }
}