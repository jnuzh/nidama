        ...
        while 1:
            ...
            try:
                ...
                if featureName == "Perl Debugging":
                    ...
                    if self._hgSvc and self._prefs.getBoolean("hgEnabled"):
                    ...
                    if self._gitSvc and self._prefs.getBoolean("gitEnabled"):
                    ...
                    if self._bzrSvc and self._prefs.getBoolean("bzrEnabled"):
