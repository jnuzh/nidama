...
#          "install.sh" which will launch this script
#          properly.
#********************************************************************
...
gKomodoVer = "8.5"
gDefaultInstallDir = "~/Komodo-IDE-8"
...
""" % (absInstallDir, absInstallDir)
    shortcutName = "komodo-ide-8.desktop"
    ...
    try:
        ...
        log.info("'Komodo IDE 8' desktop shortcut created at '%s'",
                 shortcutPath)
